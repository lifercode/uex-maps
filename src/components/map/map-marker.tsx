...
function IconMarker() {
  return (
    <svg display="block" height="41px" width="27px" viewBox="0 0 27 41">
      ...
      <path fill="#ce3f3f" d="M27,13.5C27,19.07 20.25,27 14.75,34.5C14.02,35.5 12.98,35.5 12.25,34.5C6.75,27 0,19.22 0,13.5C0,6.04 6.04,0 13.5,0C20.96,0 27,6.04 27,13.5Z"></path>
...
export function MapMarker({ data, map, onClick, isSelected }: MapMarkerProps) {
  ...
  useEffect(() => {
    ...
    el.innerHTML = `
      <div style="display: flex; flex-direction: column; align-items: center; justify-content: center;">
        ${renderToString(<IconMarker />)}
      </div>
      <div style="background: white; border-radius: 9999px; padding: 0 0.5rem; box-shadow: 0 0 2px rgba(0,0,0,0.3);">
        ${data?.name}
      </div>
    `
    ...
    const marker = new mapboxgl.Marker({ element: el })
      .setLngLat(data?.coordinates || [0,0])
      .addTo(map)
